...
if dein#load_state('~/.cache/dein')
  ...
  call dein#add('liuchengxu/vim-which-key')       " Keybind manager
  call dein#add('junegunn/goyo.vim')              " Zen writing
  call dein#add('LnL7/vim-nix')                   " Nix language support
  call dein#add('vifm/vifm.vim')                  " File managment
  call dein#add('vimwiki/vimwiki')                " Personal wiki/diary
  call dein#add('ChristianChiarulli/codi.vim')    " Interactive stuff
  call dein#add('godlygeek/tabular')              " Tables? Vim markdown dep
